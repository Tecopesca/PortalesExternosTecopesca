export const environment = {
  production: true,
  clienteLogin:  'http://mail.gcv.ec:8042/ws_dd_externo_portales/Sistemas/Sistemas.svc?singleWsdl',
  clienteproceso: 'http://mail.gcv.ec:8042/ws_dd_externo_portales/Clientes/Exportaciones/Exportaciones.svc?singleWsdl',
  proveedorlogin:'http://mail.gcv.ec:8042/ws_dd_externo_portales_desarrollo/Sistemas/Sistemas.svc?singleWsdl',
  proveedorproceso:'http://mail.gcv.ec:8042/ws_dd_externo_portales_desarrollo/Adquisiciones/Solicitud_compra/Solicitud_compra.svc?singleWsdl',
};
